package com.hc.mall.product.exception;
...
@Slf4j
@RestControllerAdvice(basePackages = "com.hc.mall.product.controller")
public class MallExceptionAdvice {
    @ExceptionHandler(value = {MethodArgumentNotValidException.class})
    public R GulimallExceptionAdvice(MethodArgumentNotValidException e) {
